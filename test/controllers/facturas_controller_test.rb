...
class FacturasControllerTest < ActionController::TestCase
  ...
  test "should create factura" do
    assert_difference('Factura.count') do
      post :create, factura: { observacion: @factura.observacion, sucursal_id: @factura.sucursal_id, valor_articulo: @factura.valor_articulo }
    end
  ...
  test "should update factura" do
    patch :update, id: @factura, factura: { observacion: @factura.observacion, sucursal_id: @factura.sucursal_id, valor_articulo: @factura.valor_articulo }
    assert_redirected_to factura_path(assigns(:factura))
  end
